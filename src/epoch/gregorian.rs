...
mod bolero_harnesses {
    ...
    fn bolero_test_0_is_gregorian_valid() {
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_1_january_years() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_3_usual_days_per_month() {
        bolero::check!()
            .with_type()
            .cloned()
