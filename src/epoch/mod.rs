...
mod bolero_harnesses {
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_7_div_euclid_f64() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_8_rem_euclid_f64() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_21_to_time_scale() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, ts): (Epoch, TimeScale)| Some(callee.to_time_scale(ts)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_22_from_tai_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_23_from_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_24_to_duration_since_j1900() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_duration_since_j1900()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_25_from_tai_parts() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_26_from_tai_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_27_from_tai_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_28_from_utc_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_29_from_utc_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_30_from_utc_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_31_from_gpst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_32_from_qzsst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_33_from_gst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_34_from_bdt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_35_from_mjd_tai() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_36_from_mjd_in_time_scale() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_37_from_mjd_utc() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_38_from_mjd_gpst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_39_from_mjd_qzsst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_40_from_mjd_gst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_41_from_mjd_bdt() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_42_from_jde_tai() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_43_from_jde_in_time_scale() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(days, time_scale): (f64, TimeScale)| {
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_44_from_jde_utc() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_45_from_jde_gpst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_46_from_jde_qzsst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_47_from_jde_gst() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_48_from_jde_bdt() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_49_from_tt_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_50_from_tt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_51_from_et_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_52_from_et_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_53_from_tdb_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_54_from_tdb_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|duration_since_j2000: Duration| {
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_56_from_jde_tdb() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_57_from_gpst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_58_from_gpst_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_59_from_gpst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_60_from_qzsst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_61_from_qzsst_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_62_from_qzsst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_63_from_gst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_64_from_gst_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_65_from_gst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_66_from_bdt_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_67_from_bdt_days() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_68_from_bdt_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_69_from_unix_duration() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_70_from_unix_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_71_from_unix_milliseconds() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_72_delta_et_tai() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_74_from_time_of_week() {
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_75_from_time_of_week_utc() {
        bolero::check!()
            .with_type()
            .cloned()
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_76_from_day_of_year() {
        bolero::check!().with_type().cloned().for_each(
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_77_leap_seconds_iers() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.leap_seconds_iers()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_78_leap_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, iers_only): (Epoch, bool)| Some(callee.leap_seconds(iers_only)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_79_to_isoformat() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_isoformat()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_80_to_duration_in_time_scale() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, ts): (Epoch, TimeScale)| {
                Some(callee.to_duration_in_time_scale(ts))
            });
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_81_to_nanoseconds_in_time_scale() {
        bolero::check!().with_type().cloned().for_each(
            |(callee, time_scale): (Epoch, TimeScale)| {
                Some(callee.to_nanoseconds_in_time_scale(time_scale))
            },
        );
    }
    ...
    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_82_to_tai_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tai_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_83_to_tai_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tai_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_84_to_tai() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_tai(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_85_to_tai_parts() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tai_parts()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_86_to_tai_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tai_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_87_to_utc_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_utc_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_88_to_utc_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_utc_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_89_to_utc() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_utc(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_90_to_utc_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_utc_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_91_to_mjd_tai_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_tai_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_92_to_mjd_tai_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_tai_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_93_to_mjd_tai() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_mjd_tai(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_94_to_mjd_utc_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_utc_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_95_to_mjd_utc() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_mjd_utc(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_96_to_mjd_utc_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_utc_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_97_to_jde_tai_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tai_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_98_to_jde_tai() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_jde_tai(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_99_to_jde_tai_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tai_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_100_to_jde_tai_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tai_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_101_to_jde_utc_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_utc_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_102_to_jde_utc_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_utc_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_103_to_jde_utc_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_utc_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_104_to_tt_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tt_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_105_to_tt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tt_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_106_to_tt_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tt_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_107_to_tt_centuries_j2k() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tt_centuries_j2k()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_108_to_tt_since_j2k() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tt_since_j2k()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_109_to_jde_tt_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tt_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_110_to_jde_tt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tt_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_111_to_mjd_tt_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_tt_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_112_to_mjd_tt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_mjd_tt_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_113_to_gpst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gpst_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_114_to_gpst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gpst_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_115_to_gpst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gpst_nanoseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_116_to_gpst_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gpst_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_117_to_qzsst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_qzsst_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_118_to_qzsst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_qzsst_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_119_to_qzsst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_qzsst_nanoseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_120_to_qzsst_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_qzsst_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_121_to_gst_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gst_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_122_to_gst_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gst_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_123_to_gst_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gst_nanoseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_124_to_gst_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_gst_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_125_to_bdt_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_bdt_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_126_to_bdt_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_bdt_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_127_to_bdt_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_bdt_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_128_to_bdt_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_bdt_nanoseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_129_to_unix_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_unix_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_130_to_unix() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_unix(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_131_to_unix_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_unix_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_132_to_unix_milliseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_unix_milliseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_133_to_unix_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_unix_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_134_to_et_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_et_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_135_to_et_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_et_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_136_to_tdb_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tdb_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_137_to_tdb_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tdb_seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_138_to_jde_et_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_et_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_139_to_jde_et_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_et_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_140_to_jde_et() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|(callee, unit): (Epoch, Unit)| Some(callee.to_jde_et(unit)));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_141_to_jde_tdb_duration() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tdb_duration()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_142_to_jde_tdb_days() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_jde_tdb_days()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_143_to_tdb_days_since_j2000() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tdb_days_since_j2000()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_144_to_tdb_centuries_since_j2000() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_tdb_centuries_since_j2000()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_145_to_et_days_since_j2000() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_et_days_since_j2000()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_146_to_et_centuries_since_j2000() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_et_centuries_since_j2000()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_147_duration_in_year() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.duration_in_year()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_148_day_of_year() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.day_of_year()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_149_year() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.year()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_150_year_days_of_year() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.year_days_of_year()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_151_hours() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.hours()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_152_minutes() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.minutes()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_153_seconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.seconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_154_milliseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.milliseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_155_microseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.microseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_156_nanoseconds() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.nanoseconds()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_157_month_name() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.month_name()));
    }

    #[test]
    #[cfg_attr(kani, kani::proof)]
    fn bolero_test_158_to_rfc3339() {
        bolero::check!()
            .with_type()
            .cloned()
            .for_each(|callee: Epoch| Some(callee.to_rfc3339()));
    }
}
